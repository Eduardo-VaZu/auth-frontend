...
export const ResetPasswordPage = (): JSX.Element => {
  ...
  return (
    <>
      <Seo
        title={t('auth.resetPassword.subtitle')}
      ...
      <PageContainer className="grid gap-6 pb-14 pt-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <section className="animate-rise-in rounded-xl border border-border-subtle bg-surface p-7 sm:p-8">
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-text-primary">{t('auth.resetPassword.title')}</h1>
          <p className="mt-3 max-w-lg text-[14px] text-text-secondary sm:text-[15px] leading-relaxed">{t('auth.resetPassword.description')}</p>
        </section>
